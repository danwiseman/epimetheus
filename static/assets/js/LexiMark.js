 ...
 */
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        await import('https://cdn.skypack.dev/prismjs/components/prism-javascript.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-css.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-markup-templating.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-python.js');
        ...
        await import('https://cdn.skypack.dev/prismjs/components/prism-ruby.js');
        ...
        await import('https://cdn.skypack.dev/prismjs/components/prism-java.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-csharp.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-cpp.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-go.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-swift.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-kotlin.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-dart.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-scala.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-rust.js');
        await import('https://cdn.skypack.dev/prismjs/components/prism-perl.js');
        console.log('All Prism modules loaded!');
    });
    ...
    class LexiMark extends LitElement {
        ...
        updateMarkdown() {
            ...
            // Replace image tags with markdown syntax
            content = content.replace(/<img\s+src="(.*?)"\s+alt="(.*?)"\s*\/?>/g, '![$2]($1)');

            // Replace /image_generate?tags= pattern with markdown syntax, but only if it's not inside an image tag
            content = content.replace(/(?<!\[.*?\]\()\/image_generate\?tags=(.*?)\s/g, '![](/image_generate?tags=$1)');
